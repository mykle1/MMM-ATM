...
Module.register("MMM-ATM", {
    ...
    defaults: {
        multipleChoice: "Yes",         // No = no multiple choice answers
        useHeader: true,               // true if you want a header
        header: "Not Another Trivia Module!",    // Any text you want
        maxWidth: "250px",
		rotateInterval: 30 * 1000,      // New trivia ? rotation.
        animationSpeed: 3000,           // fade in and out speed
        initialLoadDelay: 4250,
        retryDelay: 2500,
        updateInterval: 30 * 60 * 1000, // API limits 50 questions per call 
    ...
    //        img.src = "modules/MMM-ATM/pix/2.jpg";
    //        pic.appendChild(img);
